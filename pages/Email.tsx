  ...
  return (
    <CustomScrollbar>
      <Head>
        ...
        <meta
          name="description"
          content={`Contact me for any discussions on AI/ML, data science, or interesting projects. `}
        />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="p-6 mr-2 mt-8   sm:rounded-lg">
                    ...
                    <p className="text-normal text-md font-normal text-gray-400 dark:text-gray-400 mt-2">
                      You can contact me with any questions about AI/ML, data science, or just to say hi. I am always open to collaborating on interesting projects, research, or learning opportunities.
                    </p>
